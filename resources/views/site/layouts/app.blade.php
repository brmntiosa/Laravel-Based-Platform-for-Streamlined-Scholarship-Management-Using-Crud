...
<head>
    ...
    <link href="{{ asset('global/landingpage') }}/lib/lightbox/css/lightbox.min.css" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('global/landingpage') }}/lib/parallax/parallax.min.js"></script>
    <script src="{{ asset('global/landingpage') }}/lib/isotope/isotope.pkgd.min.js"></script>
    <script src="{{ asset('global/landingpage') }}/lib/lightbox/js/lightbox.min.js"></script>
